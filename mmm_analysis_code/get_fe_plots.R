...
test <- as.numeric(args[4])

source("mmm_analysis_functions/gen_fe_plot.R")
...
fe.joint.dir <- file.path(fe.dir,"joint_plots/")
...
for (topic in topics){
  ...
  gen.fe.plot(mu.vec=mu.vec,logit.phi.vec=logit.phi.vec,
              ...
              fe.zoom.dir=fe.zoom.dir,
              fe.joint.dir=fe.joint.dir,
